...
//		Customer cSandra = new Customer("C54321", "Sandra Müller", "samue62@gmx.de");
//
...
//
//		Article aKaffeemaschine = new Article("SKU-639989", "Kaffeemaschine", 2999, 500);
//		Article aTeekocher = new Article("SKU-938637", "Teekocher", 1999, 2000);
//
//		// Eric's 1st order
...
//
//		// Timo´s order
//		Order o6655 = new Order(4835735356L, new Date(), cTimo);
//		o6655.addItem(new OrderItem(aKaffeemaschine.getDescription(), aKaffeemaschine, 1))
//				.addItem(new OrderItem(aTasse.getDescription(), aTasse, 6));
//
//		// Sandra´s order
//		Order o9575 = new Order(6399437335L, new Date(), cSandra);
//		o9575.addItem(new OrderItem(aTeekocher.getDescription(), aTeekocher, 1))
...
//			}
//			sbLineItem = fmtLine("#" + order.getId() + ", " + order.getCustomer().getFirstName() + "'s Bestellung: "
