...
public final class Application_2 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// Timo´s order
		Order o6655 = dataFactory.createOrder(cTimo);
		o6655.addItem(dataFactory.createOrderItem(aKaffeemaschine.getDescription(), aKaffeemaschine, 1))
				.addItem(dataFactory.createOrderItem(aTasse.getDescription(), aTasse, 6));

		// Sandra´s order
		Order o9575 = dataFactory.createOrder(cSandra);
		o9575.addItem(dataFactory.createOrderItem(aTeekocher.getDescription(), aTeekocher, 1))
